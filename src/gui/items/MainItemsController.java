...
public class MainItemsController {
	...
	private boolean itemPresenceControl(Cart cart, Item item, int id) throws Exception {
	...
	public void removeFromCart(String description) throws Exception {
		Iterator<Item> iteratorItem = this.cart.iteratorItemList();
